...
export default function DemoGymPage() {
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
          <div>
            <h1 className="text-4xl md:text-5xl font-heading font-bold text-foreground mb-4">
              Gym Website <span className="text-[#D4AF37]">Demo</span>
            </h1>
            <p className="text-muted max-w-xl font-body text-lg">
              Preview our high-conversion fitness center template. A dynamic design built to showcase schedules, trainers, and drive memberships.
            </p>
          </div>
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <div className="flex items-center bg-card border border-border rounded-lg p-1">
              <button
                ...
                className={`p-2 rounded-md transition-colors ${view === "desktop" ? "bg-[#D4AF37]/20 text-[#D4AF37]" : "text-muted hover:text-foreground"}`}
                title="Desktop View"
              >
                <Monitor size={20} />
              </button>
              <button
                ...
                className={`p-2 rounded-md transition-colors ${view === "mobile" ? "bg-[#D4AF37]/20 text-[#D4AF37]" : "text-muted hover:text-foreground"}`}
                title="Mobile View"
              >
                <Smartphone size={20} />
              </button>
            ...
            <a
              ...
              className="flex items-center gap-2 bg-[#D4AF37] hover:bg-[#D4AF37]/90 text-black font-semibold py-3 px-6 rounded-lg transition-all hover:-translate-y-1"
            >
