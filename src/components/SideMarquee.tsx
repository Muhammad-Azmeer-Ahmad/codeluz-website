...
export function SideMarquee() {
  return (
    <div className="fixed left-0 top-0 bottom-0 w-10 md:w-24 z-[60] pointer-events-none flex flex-col justify-start overflow-hidden bg-background/40 backdrop-blur-sm border-r border-border">
      ...
      >
        <div className="flex flex-col gap-16 py-4 items-center">
          ...
          {[...Array(10)].map((_, i) => (
            <span 
              key={i}
              className="text-xs sm:text-base md:text-2xl font-bold tracking-[0.6em] text-foreground uppercase" 
