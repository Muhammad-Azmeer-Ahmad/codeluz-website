...
const AnimatedCharacter = ({
  ...
  return (
    <span style={{ position: "relative", display: "inline-block" }}>
      ...
      {/* Visible character absolute positioned */}
      <motion.span
        style={{
          position: "absolute",
          left: 0,
    ...
    <section className={`w-full min-h-screen flex flex-col items-center justify-center relative px-5 sm:px-8 md:px-10 py-20 bg-[#0C0C0C]/80 backdrop-blur-md ${kanit.className} overflow-hidden`}>
      ...
      <div className="relative z-10 max-w-4xl w-full flex flex-col items-center gap-16 sm:gap-20 md:gap-24">
        ...
        <FadeIn delay={0.3} y={20}>
          <Link
            href="/contact"
            className="inline-flex items-center justify-center rounded-full text-white font-medium uppercase tracking-widest text-xs sm:text-sm md:text-base px-8 py-3 sm:px-10 sm:py-3.5 md:px-12 md:py-4 transition-opacity duration-200 hover:opacity-90 active:opacity-75"
            style={{
