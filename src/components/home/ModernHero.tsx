    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-40 pb-16">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
        ...
        >
          ...
          <span className="text-sm font-medium text-slate-300 tracking-wide uppercase">Next-Generation Web Platform</span>
        </motion.div>
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight text-white mb-6 leading-tight max-w-5xl"
        >
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-slate-400 max-w-2xl mb-10 leading-relaxed font-body"
        >
        ...
        >
          <Link 
            href="/services" 
            className="group relative inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-black font-semibold rounded-full overflow-hidden transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(255,255,255,0.3)]"
          >
          ...
          <Link 
            href="/contact"
            className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-white/5 text-white font-semibold rounded-full border border-white/10 backdrop-blur-md transition-all hover:bg-white/10 hover:border-white/20"
          >
            Contact Us
          </Link>
        </motion.div>
